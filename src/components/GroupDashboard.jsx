...
import { ArrowLeft, Receipt, Calendar, MapPin, Users, FileText, Wrench, MoreVertical, MoreHorizontal, Settings, LogOut, ChevronRight } from 'lucide-react';
...
function GroupDashboard({ group, currentUser, onBack}) {
  ...
  const refreshGroupData = (updatedData) => {
   ...
   return (
    ...
    paddingBottom: 'calc(120px + env(safe-area-inset-bottom, 0px)))' // ✅ Match nav height
  }}>
